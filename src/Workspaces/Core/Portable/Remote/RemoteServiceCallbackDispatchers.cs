...
{
    internal sealed class RemoteServiceCallbackDispatcherRegistry(IEnumerable<Lazy<IRemoteServiceCallbackDispatcher, ExportMetadata>> dispatchers) : IRemoteServiceCallbackDispatcherProvider
    {
